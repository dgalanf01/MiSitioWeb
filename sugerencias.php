...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="estilos/sugerencias.css">
</head>
<body>
    <header>
    ...
    <main>
        ...
        <div id="contenido">
            ...
            <div id="derecho">
                <form>
                    <label for="juego">Cu&aacute;l fue el &uacute;ltimo que jugaste?</label>
                    <input type="text" name="juego" id="juego" required placeholder="Kingdom hearts 3"><br>
                    <label for="sugerencias">Sugerencias: </label>
                    <textarea name="sugerencias" id="sugerencias" cols="30" rows="10"></textarea><br>
